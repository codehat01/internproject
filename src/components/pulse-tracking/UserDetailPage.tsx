...
import { ArrowLeft, User, Phone, Mail, MapPin, Calendar, Clock, Activity, CircleCheck as CheckCircle, Circle as XCircle, CircleAlert as AlertCircle } from 'lucide-react';
